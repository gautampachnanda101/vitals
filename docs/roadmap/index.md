...
| [005](items/005-dashboard-write-actions/) | Dashboard write actions | In progress — CSRF model, WriteAction registry, and a full `clean` preview flow (backend + button) done; single-flight guard and `/clean/apply` still open | 001, 002, 004 | v0.7.0+ |
...
| [009](items/009-raw-coverage-95/) | Raw 95%+ coverage, no live-glue exemption | Not started | — (cross-cutting) | ongoing |
