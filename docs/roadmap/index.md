...
| [005](items/005-dashboard-write-actions/) | Dashboard write actions | In progress — CSRF model, WriteAction registry, and `POST /clean/preview` backend done; button/page and `/clean/apply` still open | 001, 002, 004 | v0.7.0+ |
