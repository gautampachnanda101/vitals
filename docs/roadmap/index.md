...
| [012](items/012-disk-consumers-detail/) | Per-resource consumers: disk, network, energy | Not started — captured 2026-09-05, needs design + review | `internal/monitor` sampling (existing) | not yet |
